"""
Django settings for vpssecureserver project.
...
SECRET_KEY = 'django-insecure-_&o(-*3h%=w@)9%!77v8@78#sa-qf6jrc@y)=uww%i&5mv1-ab'
...
ROOT_URLCONF = 'vpssecureserver.urls'
...
WSGI_APPLICATION = 'vpssecureserver.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'neondb',
        'USER': 'neondb_owner',
        'PASSWORD': 'npg_NjeWA7rkxP4u',
        'HOST': 'ep-delicate-paper-adp8bqt2-pooler.c-2.us-east-1.aws.neon.tech',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
        },
